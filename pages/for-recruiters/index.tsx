    ...
    <Box>
      ...
      <Box sx={{
        ...
        <Typography sx={{
          ...
          <br />So, checkout mine below!
          <br />FYI, these are real-time leetcode stats, generated by a <u><a style={{ color: "blue" }} href="https://github.com/Pooja444/leetcode-profile-lib">project</a></u> I worked on, to extract leetcode public profile data using GraphQL
        </Typography>
      </Box>
      <Box sx={{
        ml: `${sideMargins}vw`,
        ...
        <LeetcodeProfile data={props.data}></LeetcodeProfile>
      </Box>
    </Box>
  )
}
